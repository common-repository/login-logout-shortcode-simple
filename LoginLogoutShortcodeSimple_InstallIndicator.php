...
include_once('LoginLogoutShortcodeSimple_OptionsManager.php');

class LoginLogoutShortcodeSimple_InstallIndicator extends LoginLogoutShortcodeSimple_OptionsManager {
