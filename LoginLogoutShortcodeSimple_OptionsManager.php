...
class LoginLogoutShortcodeSimple_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'login-logout-shortcode-simple'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'login-logout-shortcode-simple'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'login-logout-shortcode-simple'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'login-logout-shortcode-simple'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'login-logout-shortcode-simple');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'login-logout-shortcode-simple'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'login-logout-shortcode-simple');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'login-logout-shortcode-simple'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'login-logout-shortcode-simple') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'login-logout-shortcode-simple');
            case 'false':
                return __('false', 'login-logout-shortcode-simple');

            case 'Administrator':
                return __('Administrator', 'login-logout-shortcode-simple');
            case 'Editor':
                return __('Editor', 'login-logout-shortcode-simple');
            case 'Author':
                return __('Author', 'login-logout-shortcode-simple');
            case 'Contributor':
                return __('Contributor', 'login-logout-shortcode-simple');
            case 'Subscriber':
                return __('Subscriber', 'login-logout-shortcode-simple');
            case 'Anyone':
                return __('Anyone', 'login-logout-shortcode-simple');
        }
        return $optionValue;
    }
