...
include_once('LoginLogoutShortcodeSimple_InstallIndicator.php');

class LoginLogoutShortcodeSimple_LifeCycle extends LoginLogoutShortcodeSimple_InstallIndicator {
    ...
    public function install() {
        ...
        $this->InstallDatabaseTablesLoginLogoutShortcodeSimple();
    ...
    public function uninstall() {
        $this->otherUninstall();
        $this->unInstallDatabaseTablesLoginLogoutShortcodeSimple();
